...
namespace W4S.RegistrationMicroservice.Data.Migrations
{
    ...
    [Migration("20230216211518_Changed_profileField_nullability")]
    partial class ChangedprofileFieldnullability
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cfb6b059-ec9d-4049-bcae-5a879a7cb065"),
                            NIP = "5283121250",
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Domain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1cf48f4f-def6-4b2f-b598-a7506a5bea54"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.University", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("870c1b80-0a1b-4ef8-8a45-2268cd8345d4"),
                            EmailDomainId = new Guid("1cf48f4f-def6-4b2f-b598-a7506a5bea54"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1804d378-69ba-4b11-9be9-8b9f9e7079c2"),
                            Description = "Student"
                        },
                        new
                        {
                            Id = new Guid("eb6f95de-7cdb-4a0c-a939-9a7ce605bde6"),
                            Description = "Employer"
                        },
                        new
                        {
                            Id = new Guid("401d8379-b5c4-43cc-b697-cbd740f633de"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Users.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9eadc790-0706-4659-852b-f0d21e87ae63"),
                            Building = "2a",
                            City = "Gliwice",
                            Country = "Poland",
                            ...
                            PhoneNumber = "2137",
                            Region = "Silesia",
                            RoleId = new Guid("401d8379-b5c4-43cc-b697-cbd740f633de"),
                            SecondName = "Adminsky",
                            Street = "Akademicka",
