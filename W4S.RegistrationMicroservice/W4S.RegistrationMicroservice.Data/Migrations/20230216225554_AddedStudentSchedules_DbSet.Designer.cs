...
namespace W4S.RegistrationMicroservice.Data.Migrations
{
    ...
    [Migration("20230216225554_AddedStudentSchedules_DbSet")]
    partial class AddedStudentSchedulesDbSet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("70b8cf78-0c0e-40d8-be86-6ace64a412a4"),
                            NIP = "5283121250",
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Domain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4660f431-b1b7-4c83-a883-5730fa1508cf"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.University", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("773044e1-3f0e-4ee3-b825-378ffd8c0963"),
                            EmailDomainId = new Guid("4660f431-b1b7-4c83-a883-5730fa1508cf"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("80e91afd-22f2-4571-a3eb-b9891daf9c08"),
                            Description = "Student"
                        },
                        new
                        {
                            Id = new Guid("5f39fa5e-730d-416d-aad2-3c3a0f6db412"),
                            Description = "Employer"
                        },
                        new
                        {
                            Id = new Guid("b1bda1a8-4d8c-4f1a-b056-3bd5b34dfc07"),
            ...
            modelBuilder.Entity("W4S.RegistrationMicroservice.Data.Entities.Users.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bdb73133-143e-4b60-bb61-b0b882e38c21"),
                            Building = "2a",
                            City = "Gliwice",
                            Country = "Poland",
                            ...
                            PhoneNumber = "2137",
                            Region = "Silesia",
                            RoleId = new Guid("b1bda1a8-4d8c-4f1a-b056-3bd5b34dfc07"),
                            SecondName = "Adminsky",
                            Street = "Akademicka",
